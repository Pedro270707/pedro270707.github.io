...
class JavaTooltipStyle {
  constructor() {
    ...
    this.wordSpacing = 4;
    this.font = 'Minecraft';
    this.fontUrl = '/assets/Minecraft-Font/Minecraft.ttf';
    this.shadow = true;
  }
...
class UndertaleTooltipStyle {
  constructor() {
    ...
    this.fontUrl = '/assets/Determination-Font/Determination.ttf';
    this.shadow = false;
  }
...
function getSetting(setting, canvas) {
  return (canvas.dataset && canvas.dataset["setting" + (setting ? setting[0].toUpperCase() + setting.slice(1) : "")]) || settings[setting];
}

function setDefaultCanvasSettings(canvas) {
  let ctx = canvas.getContext('2d');
  registerFont(styles[getSetting("style", settings)].fontUrl, {family: styles[getSetting("style", settings)].font});
  // if (styles[(getSetting("style", settings))]) {
  //   const fontFile = new FontFace(
  //     styles[getSetting("style", settings)].font,
  //     "url(" + styles[getSetting("style", settings)].fontUrl + ")",
  //   );
  //   fontFile.load();
  // }
...
export { TextRenderer, drawTooltip };